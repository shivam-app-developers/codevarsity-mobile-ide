...
export const metadata: Metadata = createMetadata({
  title: 'User Guides',
  description: 'Complete guides to using CodeVarsity - getting started, features, IDE guide, and more.',
  path: '/guides',
  type: 'website',
});
...
const guides: Guide[] = [
  ...
  },
  {
    ...
    excerpt: 'Explore all the powerful features CodeVarsity has to offer.',
    icon: 'fa-star'
  },
  {
    title: 'IDE Guide',
  ...
  },
  {
    ...
    excerpt: 'Complete list of programming languages supported by CodeVarsity.',
    icon: 'fa-language'
  },
  {
    title: 'FAQ',
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <main className="flex-grow pt-28 pb-16 px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto w-full">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600 max-w-2xl mx-auto">Everything you need to get the most out of CodeVarsity.</p>
        </div>
