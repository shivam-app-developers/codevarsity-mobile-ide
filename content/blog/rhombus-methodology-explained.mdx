...
category: 'Education'
excerpt: 'How CodeVarsitys unique 4-step learning process (Learn, Visualize, Ghost, Build) ensures you actually understand code.'
---
...
CodeVarsity uses a proven 4-step methodology we call the **Rhombus Methodology**:
