          ...
          <div key={trackName} className="mb-12">
            ...
            <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {courses.map(course => {
                ...
                return (
                  <div key={course.id} className="bg-white p-6 rounded-xl border border-gray-100 shadow-sm flex flex-col group hover:border-brand-primary/20 transition-colors">
                    <div className="flex items-center justify-between mb-4">
                      ...
                      <span className="px-2 py-1 bg-gray-100 text-gray-600 text-[10px] font-black rounded-lg uppercase tracking-widest">{course.level}</span>
                    </div>
                    <h4 className="font-bold text-gray-900 mb-2 truncate">{course.title}</h4>
                    <p className="text-[13px] text-gray-500 mb-6 flex-grow leading-relaxed">Master {course.title} with interactive labs and industrial runtimes.</p>
